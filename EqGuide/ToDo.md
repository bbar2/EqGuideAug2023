...
2022-04-06: Get RocketMount and EqGuide working with Direct offset or TargetOffset modes.
2022-04-06: Set red color scheme for EqGuide
2022-04-06: Add EqGuid UI elements to show RocketMount state.  e.g. Reference set, Moving, BLE Connect, OffsetMagnitude. 
...
2022-04-06: Coordinate siderialtime and arm angle once a reference is "Marked".
...
# Done Items - date item completed.
...
2022-04-06: Decide on file format for angles.  DMS, Float, or Double.
   Done - Use Int HM(Seconds Optionsal) for Right Ascension and DM(Seconds Optional) for Declination.    
